        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Hello! I&apos;m Cristian Jay, a passionate developer and designer with a love for creating 
                digital experiences that make a real impact. My journey in tech started with curiosity 
                and has evolved into a career focused on building innovative solutions.
              </p>
              <p>
                I specialize in modern web development, with expertise in React, Next.js, TypeScript, 
                and various other technologies. I believe in writing clean, maintainable code and 
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-lg border border-border">
